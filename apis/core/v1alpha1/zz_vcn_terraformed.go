...
// GetInitParameters of this Vcn
func (tr *Vcn) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Vcn
func (tr *Vcn) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
