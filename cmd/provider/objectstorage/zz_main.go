...
import (
	...
	"github.com/upbound/provider-oci/apis"
	"github.com/upbound/provider-oci/apis/v1alpha1"
	"github.com/upbound/provider-oci/config"
	"github.com/upbound/provider-oci/internal/clients"
	"github.com/upbound/provider-oci/internal/controller"
	"github.com/upbound/provider-oci/internal/features"
)
...
func main() {
	...
	kingpin.FatalIfError(controller.Setup_objectstorage(mgr, o), "Cannot setup OCI controllers")
